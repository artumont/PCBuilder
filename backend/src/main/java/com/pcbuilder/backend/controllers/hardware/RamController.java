...
public class RamController {
    ...
    public ResponseEntity<MultiHardwareResponse> searchRam(
        ...
        if (name != null) {
            ...
            return ramService.searchByRamType(ramType);
        } else if (minCapacity != null && maxCapacity != null) {
            return ramService.searchByCapacity(minCapacity, maxCapacity);
        } else if (minSpeed != null && maxSpeed != null) {
            return ramService.searchBySpeed(minSpeed, maxSpeed);
        } else if (minPrice != null && maxPrice != null) {
            return ramService.searchByPrice(minPrice, maxPrice);
